...
(function () {
  ...
  if (IO) {
    ...
    var revealSel = '.eyebrow,h2,h3,.lead,.preface,.dc,.tb,.table-wrap,.cred,.pq,.fig,.gal figure,.cert figure,.mapwrap,.doc-title,.doc-meta,.eqp-grid,.green-note,.cc-chart,.cc-crit';
